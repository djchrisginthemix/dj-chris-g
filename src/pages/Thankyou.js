...
const Thankyou = () => {
  ...
  return (
    <div id="thank-you-page" className="bg-white">
      <Helmet>
      ...
      <div className="tct-thank-you-content max-w-7xl mx-auto px-6 py-20">
        <div className="flex flex-col items-center">
          <img src={caffeineLogo} alt="The Caffeine Team" width={200} height={200} className="" />
          <h2 className="tct-header-2 text-center mt-8 mb-10 sm:mb-12">Thank You!</h2>
          <Reveal {...revealSettings}>
            <div className="thank-you-intro text-base sm:text-lg max-w-5xl mx-auto text-center text-gray-500 mb-10 sm:mb-16 md:mb-20 lg:mb-24">
              <p className="mb-5 md:mb-6">
                Thank you for reaching out to The Caffeine Team. We have received your message and will get back to you as soon as possible.
